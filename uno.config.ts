...
export default defineConfig({
  ...
  shortcuts: {
    ...
    'jozsika-font': 'font-display',
    
    // Links
    'page-link': 'font-display text-[1.125rem] underline underline-offset-4',
    'page-link-icon': 'inline-block w-4 h-4 ml-2 align-middle',
    
    // Editorial Typography
    'editorial-display': 'max-w-[13ch] m-0 font-sans text-[clamp(2.5rem,5vw,5rem)] font-bold leading-[0.94] uppercase whitespace-pre-line',
    'editorial-heading': 'm-0 mb-[clamp(2rem,5vw,4rem)] font-sans text-[clamp(1.75rem,3.5vw,3.5rem)] font-bold leading-[1.2] normal-case whitespace-pre-line',
    'editorial-heading--compact': 'editorial-heading text-[clamp(1.8rem,3vw,3.25rem)]',
    'editorial-heading--page': 'editorial-heading text-[clamp(2.25rem,4.5vw,4.5rem)] leading-[1.2]',
    'editorial-eyebrow': 'm-0 mb-8 font-sans text-[0.8rem] font-semibold uppercase',
    'editorial-lede': 'm-0 font-sans text-[clamp(1.2rem,2vw,1.75rem)] leading-[1.45] whitespace-pre-line max-w-[31rem]',
    'editorial-body': 'm-0 font-sans text-[clamp(1rem,1.5vw,1.25rem)] leading-[1.45] whitespace-pre-line',
    
    // Link
    'editorial-link': 'inline-flex w-max items-center gap-[0.25em] mt-8 border-b border-current pb-[0.1em] text-[0.95rem] uppercase decoration-none transition-opacity duration-200 hover:opacity-70 after:content-empty after:inline-block after:w-[1.1em] after:h-[1.1em] after:bg-current after:[mask:url("data:image/svg+xml;utf8,<svg_xmlns=\'http://www.w3.org/2000/svg\'_width=\'24\'_height=\'24\'_viewBox=\'0_0_24_24\'_fill=\'none\'_stroke=\'currentColor\'_stroke-width=\'1.5\'_stroke-linecap=\'round\'_stroke-linejoin=\'round\'><path_d=\'M7_17L17_7\'/><path_d=\'M7_7h10v10\'/></svg>")_no-repeat_center/contain] after:[-webkit-mask:url("data:image/svg+xml;utf8,<svg_xmlns=\'http://www.w3.org/2000/svg\'_width=\'24\'_height=\'24\'_viewBox=\'0_0_24_24\'_fill=\'none\'_stroke=\'currentColor\'_stroke-width=\'1.5\'_stroke-linecap=\'round\'_stroke-linejoin=\'round\'><path_d=\'M7_17L17_7\'/><path_d=\'M7_7h10v10\'/></svg>")_no-repeat_center/contain]',
