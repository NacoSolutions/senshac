...
- Plaintext secrets remain ignored and local-only. SOPS/age encrypted bundles can move into the meta repo or focused repos only after `senshac-8521` proves decrypt, rotation, recovery, and CI/Act behavior.
