 ...
 * `ROUTE_TABLE` constant in `src/pages/` so the published
...
export function buildDocument(routes: readonly Route[], version: string): OpenApiDocument {
	...
	return {
		openapi: "3.1.0",
		info: {
			title: "Senshac HTTP API",
			version,
			description:
				"Auto-generated from `src/pages/`'s `ROUTE_TABLE`. " +
...
function main(): void {
	...
	if (checkMode) {
		...
		if (existing !== content) {
			console.error("docs/openapi.yaml is stale relative to src/pages/.");
